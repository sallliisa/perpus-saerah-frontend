...
const sections = [
  {
    title: `Privacy Policy for ${config.name}`,
    content: [`At ${config.url}, accessible from ${config.url}, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by ${config.url} and how we use it.`, `If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.`, `This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in ${config.url}. This policy is not applicable to any information collected offline or via channels other than this website.`],
  },
  {
    title: `Consent`,
  ...
  },
  {
    ...
    content: [`Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.`, `${config.url} does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.`],
  },
]
</script>

<template>
  <div class="flex w-full items-center justify-center bg-c-background text-c-on-surface dark:bg-cd-background dark:text-cd-on-surface">
    <div class="my-4 flex min-h-screen max-w-5xl flex-col gap-8 rounded-lg bg-c-surface-container px-4 py-8 dark:bg-cd-surface-container">
